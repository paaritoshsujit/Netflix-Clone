  ...
  return (
    <div className="min-h-screen flex justify-center flex-col items-center relative">
      <div className="flex justifiy-center flex-col items-center">
        <h1 className="text-white font-bold text-[54px] my-[35px]">
          Who's Watching?
        </h1>
        <ul className="flex gap-8 p-0 my-[25px]">
          ...
          {accounts && accounts.length < 4 ? (
            <li
              ...
              className="border text-black font-bold bg-[#e5b109] text-lg border-black max-w-[200px] rounded min-w-[84px] max-h-[200px] min-h-[84px] w-[155px] h-[155px] cursor-pointer flex justify-center items-center"
            >
              Add Account
            </li>
          ) : null}
